...
(function () {
    ...
    function pageEditController($location, pageService, $routeParams, $route, $anchorScroll, currentUser) {

        var pageEditCtrl = this;
        pageEditCtrl.userId = currentUser._id;
        ...
        function updatePage() {
            pageService.updatePage(pageEditCtrl.pageId, pageEditCtrl.currentPage)
                .then(function () {
                    $location.url('/website/' + pageEditCtrl.websiteId + '/page');
